package com.example.parcial2pdm.screens.QuestionScreen
...
import com.example.parcial2pdm.data.database.QuestionViewModel
                    ...
                    items(items = questions, key = { it.id }) { question ->
                        ElevatedCard(
                            ...
                            ListItem(
                                ...
                                trailingContent = {
                                    Row {
                                        IconButton(onClick = { onManageOptions(question.id) }) {
                                            Icon(
                                                imageVector = Icons.Default.Settings,
                                                contentDescription = "Administrar opciones de ${question.title}",
                                                tint = MaterialTheme.colorScheme.primary
                                            )
                                        }
                                        IconButton(onClick = { viewModel.deleteOption(question) }) {
                                            Icon(
